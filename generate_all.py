...
TZ='-0500'
ECLUB=('English Club TV','English Club TV','https://raw.githubusercontent.com/picons/picons/master/build-source/logos/englishclubtv.default.png','https://dash2.antik.sk/live/test_ectv_hd_1200/playlist.m3u8')
...
for g in order:
    ...
    add('',ECLUB[1],ECLUB[0],ECLUB[2],ECLUB[3],g)
